...
TEST_CASE("libparsers - util - match_against_lower") {
	...
	CHECK_EQ(parsers::util::match_against_lower("HeLlo"s, "hello"), true);
	CHECK_EQ(parsers::util::match_against_lower("Hello"s, "hell", false), true);
	CHECK_EQ(parsers::util::match_against_lower("Hell"s, "hello", false), true);
	CHECK_EQ(parsers::util::match_against_lower("Hello"s, "hell"), false);
	CHECK_EQ(parsers::util::match_against_lower("Hell"s, "hello"), false);
