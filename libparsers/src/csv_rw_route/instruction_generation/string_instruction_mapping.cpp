...
namespace csv_rw_route {
	namespace instruction_generation {
		...
		const std::map<std::string, decltype(instructions::structure::command::command_type)>
		    command_type_mapping{
		        ...
		        {"structure.walll"s, instructions::structure::command::wall_l},
		        {"structure.wallr"s, instructions::structure::command::wall_r},
		        {"structure.dikel"s, instructions::structure::command::dike_l},
		        {"structure.diker"s, instructions::structure::command::dike_r},
		        {"structure.forml"s, instructions::structure::command::form_l},
		        {"structure.formr"s, instructions::structure::command::form_r},
		        {"structure.formcl"s, instructions::structure::command::form_cl},
		        {"structure.formcr"s, instructions::structure::command::form_cr},
		        {"structure.roofl"s, instructions::structure::command::roof_l},
		        {"structure.roofr"s, instructions::structure::command::roof_r},
		        {"structure.roofcl"s, instructions::structure::command::roof_cl},
		        {"structure.roofcr"s, instructions::structure::command::roof_cr},
		        {"structure.crackl"s, instructions::structure::command::crack_l},
		        {"structure.crackr"s, instructions::structure::command::crack_r},
		        {"structure.freeobj"s, instructions::structure::command::free_obj},
		        ...
		        {"@@object@@walll"s, instructions::structure::command::wall_l},
		        {"@@object@@wallr"s, instructions::structure::command::wall_r},
		        {"@@object@@dikel"s, instructions::structure::command::dike_l},
		        {"@@object@@diker"s, instructions::structure::command::dike_r},
		        {"@@object@@forml"s, instructions::structure::command::form_l},
		        {"@@object@@formr"s, instructions::structure::command::form_r},
		        {"@@object@@formcl"s, instructions::structure::command::form_cl},
		        {"@@object@@formcr"s, instructions::structure::command::form_cr},
		        {"@@object@@roofl"s, instructions::structure::command::roof_l},
		        {"@@object@@roofr"s, instructions::structure::command::roof_r},
		        {"@@object@@roofcl"s, instructions::structure::command::roof_cl},
		        {"@@object@@roofcr"s, instructions::structure::command::roof_cr},
		        {"@@object@@crackl"s, instructions::structure::command::crack_l},
		        {"@@object@@crackr"s, instructions::structure::command::crack_r},
