...
TEST_CASE("libparsers - b3d_csv_object - command execution - face creation") {
	b3d::InstructionList const
	    instructions{b3d::instructions::AddVertex{0, 0, 0, 1, 1, 1},
	                 b3d::instructions::AddVertex{1, 0, 0, 1, 1, 1},
	                 b3d::instructions::AddVertex{1, 1, 0, 1, 1, 1},
	                 b3d::instructions::AddVertex{0, 1, 0, 1, 1, 1},
