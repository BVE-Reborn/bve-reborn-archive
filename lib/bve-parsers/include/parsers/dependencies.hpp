...
namespace bve::parsers::dependencies {
	struct Texture {
		...
		friend bool operator<(const Texture& lhs, const Texture& rhs) {
			return std::make_tuple(lhs.file, lhs.decal_transparent_color.x, lhs.decal_transparent_color.y, lhs.decal_transparent_color.z,
			                       lhs.has_transparent_color)
			       < std::make_tuple(rhs.file, rhs.decal_transparent_color.x, rhs.decal_transparent_color.y, rhs.decal_transparent_color.z,
